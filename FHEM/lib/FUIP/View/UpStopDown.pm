...
sub getHTML($){
	...
	my $result = '<div style="width:100px;height:136px;">
					<div style="position:absolute;top:0px;'.$left.'" data-type="push" data-device="'.$self->{device}.'" data-icon="fa-chevron-up" data-background-icon="fa-square-o" data-set-on="'.$self->{setUp}.'" 
					...
					<div style="position:absolute;top:84px;'.$left.'" data-type="push" data-device="'.$self->{device}.'" data-icon="fa-chevron-down" data-background-icon="fa-square-o" data-set-on="'.$self->{setDown}.'" 
